...
<% 
    ...
    String dbUname="", dbAvatar="";
            ...
            session.setAttribute("gameCheck", "TEKKEN 7");
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="bar"> 
            ...
            <div class="nav-content">
                ...
                <div class="drop-games" onclick="openLibrary()">
                    <div class="drop-games-button" >
                        ...
                        <div class="game-menu">
                            ...
                            <p class="current-game"> TEKKEN 7 </p> 
                        </div>
                ...
                <div class="nav-option" >
                    <a class="option" href="main-tekken.jsp" >HOME</a>
                    <a class="option" href="courses/tekken7-courses.jsp">COURSES</a>
                     ...
                     <div class="payment-box"> 
                        ...
                        <div class="coach-payment-profile">
                            ...
                            <div class="coach-infoP">
                                ...
                                <p class="curr-rank">
                                    <img class="coach-rank" src="assets/tekken-ranks/Emblem_TGP.png">TGP
                                </p>
                            </div>
