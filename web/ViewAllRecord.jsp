        ...
        <section class="myaccount-section">
            <div class="myaccount-container">
                ...
                <div>
                    ...
                    <button class="button1" onclick="deleteOpenForm()">Delete
                        Record</button>
                    <button class="button1" onclick="verifyOpenForm()">Verify
                        Record</button>
                    ...
                    <form class="lg-form" method="POST" action="PDFServlet">
                        <button class="button1" name="pdfbutton"
                                value="alluserpdf">Download All Record</button>
                ...
                <div class="form-popup" id="deleteForm">
                    <form action="DeleteRecordServlet" class="form-container">
                        ...
                        <button type="submit" class="submit">Submit</button>
                        <button type="button" class="cancel"
                                onclick="deleteCloseForm()">Cancel</button>
                    </form>
                </div>
                <script>
                    function openForm() {
