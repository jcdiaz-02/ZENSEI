<%-- 
    Document   : subscribe
    Created on : 05 20, 21, 2:33:22 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Get Subscription</title>
        
        <link rel="icon" href="assets/zensei-logo.svg" sizes="any" type="image/svg+xml">
        <link rel="stylesheet" href="design/subscription-style.css">
    ...
    <body>
        ...
        <div class="bar"> 
            ...
            <a href="main-lol.jsp" class="top-continue"  onclick="window.history.go(-1); return false;">Continue as a free member ></a>
        </div>
            ...
            <div class="info-container">
                <div class="welcome-container" title="Photo from: https://leaguefeed.net/best-zed-skins/">
                    <div class="subscription-title">
                        <p class="subscription-head">PREMIUM </p>
                        <p class="subscription-head2">MEMBERSHIP </p>
                    </div>
                    ...
                    <div class="subscription-box">
                        ...
                        <div class="payment-features">
                            <p><i class="fa fa-check" aria-hidden="true"></i> Get Access to all courses</p>
                            <p><i class="fa fa-check" aria-hidden="true"></i> Chat with coaches without limits</p>
                            <p><i class="fa fa-check" aria-hidden="true"></i> 10% off coaching services</p>
                        </div>
        ...
        <div id="cardModal" class="modal">
            <form class="modal-box" method="post" action="SubscribeServlet">
