	...
	<section class="personal-records-section-2">
		...
		<form class="personal-records-info-container0" method="POST" action="../UpdateRecordServlet">
			...
			<h1>Name: </h1><input type="text" placeholder="Enter Name" name="myname"><br>
                    ...
                    <div class='personal-records-info-container1'>
			<h1>Username: </h1><input type="text" placeholder= "Enter Username"name="uname"><br>
		    </div>

                    <div class='personal-records-info-container1'>
			<h1>Password: </h1><input type="text" placeholder="Enter Password" name="pass"><br>
		    </div>
		    ...
		    <div class='personal-records-info-container1'>
			<h1>Contact Number: </h1><input type="number" placeholder="Enter Contact Number" name="cnumber"><br>
                    </div>
		    ...
		    <div class='personal-records-info-container1'>
			<h1>Role: </h1><input type="text" placeholder="Enter Role" name="userrole"><br>
		    </div>
