            ...
            <div class="info-container">
                <div class="course-container">
                    ...
                    <div class="course-header">
                          <h2 class="course-title">THE ROLES</h2>
                          <h3 class="course-info">This course is dedicated to each of the 4 major roles found within VALORANT itself, alongside how to be a good teammate in general</h3>
                          <p> 5 videos | ##min </p>
                    ...
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=0GV0Y5ww1XQ&list=PLLb7YtvDEy5N4Bk_YB9na2ghr0Mp8eDC3&index=1">
                        <div class="course-img">
                            <img  src="https://img.youtube.com/vi/0GV0Y5ww1XQ/maxresdefault.jpg" title="Photo from: https://www.youtube.com/watch?v=0GV0Y5ww1XQ&list=PLLb7YtvDEy5N4Bk_YB9na2ghr0Mp8eDC3&index=1">
                        </div>
                        <div class="course-info">
                            <p class="info-header">The Initiators </p>
                            <p class="info-sub">Learn about Initiators </p>
                        </div>
                    </div>
                    
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href=" https://www.youtube.com/watch?v=TvwidW99zNY">
                        <div class="course-img">
                            <img  src="https://img.youtube.com/vi/TvwidW99zNY/maxresdefault.jpg" title="Photo from:  https://www.youtube.com/watch?v=TvwidW99zNY">
                        </div>
                        <div class="course-info">
                            <p class="info-header">The Controllers </p>
                            <p class="info-sub">Learn about Controllers </p>
                        </div>
                    </div>      
                    
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=qJpiDdMLscI&list=PLLb7YtvDEy5N4Bk_YB9na2ghr0Mp8eDC3&index=4">
                        <div class="course-img">
                            <img  src="https://img.youtube.com/vi/qJpiDdMLscI/maxresdefault.jpg" title="Photo from: https://www.youtube.com/watch?v=qJpiDdMLscI&list=PLLb7YtvDEy5N4Bk_YB9na2ghr0Mp8eDC3&index=4">
                        </div>
                        <div class="course-info">
                            <p class="info-header">The Sentinels </p>
                            <p class="info-sub">Learn about Sentinels </p>
                        </div>
                    </div>
                    
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href="https://youtube.com/watch?v=OVLNgqMKKEY ">
                        <div class="course-img">
                            <img  src="https://img.youtube.com/vi/OVLNgqMKKEY/maxresdefault.jpg" title="Photo from: https://youtube.com/watch?v=OVLNgqMKKEY ">
                        </div>
                        <div class="course-info">
                            <p class="info-header">The Duelists </p>
                            <p class="info-sub">Learn about Duelists </p>
                        </div>
                    </div>
                    
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href="https://youtube.com/watch?v=VY29d_xDAaY">
                        <div class="course-img">
                            <img  src="https://img.youtube.com/vi/VY29d_xDAaY/maxresdefault.jpg" title="Photo from: https://youtube.com/watch?v=VY29d_xDAaY">
                        </div>
                        <div class="course-info">
                            <p class="info-header">Team Play </p>
                            <p class="info-sub">Learn how to be a Good Teammate </p>
                        </div>
                    </div>
                </div>
            </div>
