            ...
            <div class="login-container">
                ...
                <div class="input-container">
                    <form class="lg-form" method="POST" action="UpdateRecordServlet">
                        ...
                        <div class="input">
                            <h1>Email: </h1><input type="email" placeholder="Enter Email"
                                                   name="email">
                        </div>
                        ...
                        <div class="input">
                            ...
                            <h1>Name: </h1><input type="text" placeholder="Enter Name"
                                                  name="myname">
                        </div>
                        <div class="input">

                            <h1>Course: </h1><input type="text" placeholder="Enter Course"
                                                    name="course">
                        </div>
                        <div class="input">

                            <h1>Age: </h1><input type="number" placeholder="Enter Age"
                                                 name="age">
                        </div>
                        ...
                        <div class="input">
                            ...
                            <h1>Gender: </h1><input type="text" placeholder="Enter Gender"
                                                    name="gender">
                        </div>
                        ...
                        <div class="input">
                            ...
                            <h1>Student Number: </h1><input type="number"
                                                            placeholder="Enter Student Number" name="snumber">
                        </div>

                        <div class="input">

                            <h1>Favorite Game: </h1><input type="text"
                                                           placeholder="Enter Favorite Game" name="favgame">
                        </div>

                        <div class="input">

                            <h1>Contact Number: </h1><input type="number"
                                                            placeholder="Enter Contact Number" name="cnumber">
                        </div>

                        <div class="input">

                            <h1>Address: </h1><input type="text" placeholder="Enter Address"
                                                     name="homeaddress">
                        </div>
                        <div class="input">

                            <h1>Role: </h1><input type="text" placeholder="Enter Role"
                                                  name="userrole">
                        </div>
