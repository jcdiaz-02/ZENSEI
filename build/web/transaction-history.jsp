<%-- 
    ...
    Created on : 05 22, 21, 12:29:48 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="design/transaction-style.css">
            ...
            <div class="transaction-container">
                <div class="transaction-head">
                    <div class="transaction-history"> 
                      ...
                      <form method="get" action="PdfServletTransaction">
                          <button type="submit" name="transactionPDF" class="transactionPDF-btn">
                              <i class="fa fa-arrow-circle-down" aria-hidden="true"></i>Download Transaction History
                          </button>
                    </div>
                    </form>
                </div>
