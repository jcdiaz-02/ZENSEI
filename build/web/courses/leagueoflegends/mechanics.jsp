            ...
            <div class="info-container">
                <div class="course-container">
                    ...
                    <div class="course-header">
                          <h2 class="course-title">THE MECHANICS</h2>
                          <h3 class="course-info">Learn more about the mechanics of the game. Knowing what characters to pick, knowing how to build them, etc.</h3>
                          <p> 5 videos | 56min </p>
                    ...
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=XFvrkUZZ5EY">
                        <div class="course-img">
                            <img  src="https://i.ytimg.com/vi/XFvrkUZZ5EY/maxresdefault.jpg" title="Photo from: https://www.youtube.com/watch?v=XFvrkUZZ5EY">
                        </div>
                        <div class="course-info">
                            <p class="info-header">Itemization Guide </p>
                            <p class="info-sub">Learn how to itemize your champions </p>
                        </div>
                    </div>
                    
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=ULcsm3VB8gA">
                        <div class="course-img">
                            <img  src="https://i.ytimg.com/vi/ULcsm3VB8gA/maxresdefault.jpg" title="Photo from: https://www.youtube.com/watch?v=ULcsm3VB8gA">
                        </div>
                        <div class="course-info">
                            <p class="info-header">How to Ward </p>
                            <p class="info-sub">Learn Warding Spots</p>
                        </div>
                    </div>      
                    
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=6iYuWLoGAek">
                        <div class="course-img">
                            <img  src=" https://i.ytimg.com/vi/6iYuWLoGAek/maxresdefault.jpg" title="Photo from: https://www.youtube.com/watch?v=6iYuWLoGAek">
                        </div>
                        <div class="course-info">
                            <p class="info-header">ADC Rotation Guide </p>
                            <p class="info-sub">Guide to learn ADC rotations </p>
                        </div>
                    </div>
                    
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=YDyyp5Z5KvM">
                        <div class="course-img">
                            <img  src="https://i.ytimg.com/vi/YDyyp5Z5KvM/maxresdefault.jpg" title="Photo from: https://www.youtube.com/watch?v=YDyyp5Z5KvM">
                        </div>
                        <div class="course-info">
                            <p class="info-header">Ganking Guide </p>
                            <p class="info-sub">Learn to Gank as a Jungler or Laner</p>
                        </div>
                    </div>
                    
                    <div class="venobox preview-1" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=iQ4WlLeCvP4">
                        <div class="course-img">
                            <img  src="https://i.ytimg.com/vi/iQ4WlLeCvP4/maxresdefault.jpg" title="Photo from: https://www.youtube.com/watch?v=iQ4WlLeCvP4">
                        </div>
                        <div class="course-info">
                            <p class="info-header">ROLE BASICS </p>
