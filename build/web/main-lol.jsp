...
<% 
    ...
    String dbUname="", dbAvatar="";
           ...
           session.setAttribute("gameCheck", "LEAGUE OF LEGENDS");
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="bar"> 
            ...
            <div class="nav-content">
                ...
                <div class="drop-games" onclick="openLibrary()">
                    <div class="drop-games-button" >
                        ...
                        <div class="game-menu">
                            ...
                            <p class="current-game"> LEAGUE OF LEGENDS </p> 
                        </div>
                ...
                <div class="nav-option" >
                    <a class="option"  href="main-lol.jsp">HOME</a>
                    <a class="option" href="courses/leagueoflegends-courses.jsp">COURSES</a>
            ...
            <div class="info-container">
                <div class="course-container">
                    ...
                    <div class="course-header">
                     ...
                     <a href="courses/leagueoflegends/rolebasics.jsp">
                        <div class="preview-1"  >
                            <div class="course-img">
                                <img  src="assets/lol/Ryze_0.jpg" title="Photo from: https://na.leagueoflegends.com/en-us/champions/ryze/">
                            </div>
                    ...
                    <% 
                        ...
                        {
                           courseRef= "courses/leagueoflegends/mechanics.jsp";
                           courseRef1= "courses/leagueoflegends/gameplay.jsp";
                        }
                     %>
                    <a href="<% out.println(courseRef);%>">
                        <div class="preview-1"  >
                            <div class="course-img">
                                <img  src="https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Yasuo_0.jpg" title="Photo from: https://na.leagueoflegends.com/en-us/champions/yasuo/">
                            </div>
                            <div class="course-info">
                                <p class="info-header">The Mechanics </p>
                    ...
                    <a href="<% out.println(courseRef1);%>">
                        <div class="preview-1"  >
                            <div class="course-img">
                                <img  src="https://lolwp.com/wp-content/uploads/2012/11/Project-Zed.jpg" title="Photo from: https://lolwp.com/zed/project-zed/">
                            </div>
                            <div class="course-info">
                                <p class="info-header">Improve your Gameplay</p>
                                <p class="info-sub">5 video lessons</p>
                            </div>
                        </div>
                    </a>
                     ...
                     <div class="payment-box"> 
                        ...
                        <div class="coach-payment-profile">
                            ...
                            <div class="coach-infoP">
                                ...
                                <p class="curr-rank">
                                    <img class="coach-rank" src="assets/lol-ranks/Emblem_Challenger.png">Challenger
                                </p>
                            </div>
